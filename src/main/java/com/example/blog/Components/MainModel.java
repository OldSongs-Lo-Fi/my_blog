...
public class MainModel {
    ...
    //INSERT///////////////////////////////////////////////////////////////
    public void insertPost(String title, String main_text, String image){

        String sql = "INSERT INTO post(title, main_text, image) VALUES ('" + title + "', '" + main_text + "', '" + image + "');";
    ...
    public void insertPost(String title, String main_text){
        ...
        String sql = "INSERT INTO post(title, main_text) VALUES ('" + title + "', '" + main_text + "');";
        int users = jdbcTemplate.update(sql);
        System.out.println(users);
    }
